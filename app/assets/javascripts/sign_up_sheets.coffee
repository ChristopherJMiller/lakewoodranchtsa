...
$(document).on 'turbolinks:load', ->
  ...
  $('#new_sign_up_sheet').on 'ajax:error', (evt, xhr, status, error) ->
    ...
    if !xhr.responseJSON?
      ...
      return
    for form of errors
      fieldSet = $(this).find("#sign_up_sheet_#{form}").parent()
