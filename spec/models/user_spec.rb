...
RSpec.describe User, type: :model do
  ...
  it 'will not be valid with a missing email' do
  ...
  it 'will not be valid with an invalid email' do
  ...
  it 'will not be valid with a mismatched password' do
  ...
  it 'will not be valid with a duplicate email' do
  ...
  it 'will not be valid with an unroutable email' do
  ...
  it 'will not be valid with an undefined verified' do
