...
RSpec.describe Submission, type: :model do
  ...
  it 'will not be valid with a missing binder status' do
  ...
  it 'will not be valid with an invalid binder status' do
  ...
  it 'will not be valid with missing tasks' do
  ...
  it 'will not be valid with an invalid task text' do
  ...
  it 'will not be valid with a missing goals text' do
  ...
  it 'will not be valid with an invalid goals text' do
